    ...
    def eraseOverlapIntervals(self, intervals: List[List[int]]) -> int:
        ...
        for curr_interval in intervals[1:]:
            ...
            #2)if previous_interval is overlapping curr_interval
                ...
                #2.1)remove one_interval with larger end / choose one_interval with smaller end
                #2.1)one_interval with smaller end become previous_interval, previous_interval compare with next_interval  
