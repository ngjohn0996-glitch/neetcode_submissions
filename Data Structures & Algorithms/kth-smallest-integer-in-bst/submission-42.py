...
class Solution: 
    ...
    def inorder_dfs(self, node):
        #4)run untill leftest_leaf_node(receive two value) || return None >> continue parent_call, continue parent_second_call / continue parent_second_call, run untill DFS_last_node
        if not node:
            return None
