class Solution:
    def numIslands(self, grid: List[List[str]]) -> int:
        ...
        queue, set_01 = deque(), set()   #seen_island
        island = 0
            ...
            while queue:
                ...
                for diff_column, diff_row in nxt_coor:
                    ...
                    if (new_column in range(total_column) and
                        ...
                        (new_column, new_row) not in set_01 and
                        grid[new_row][new_column] == "1"):

                        #2)add curr_island's next_coor_island into queue
                        queue.append((new_column, new_row))

                        #3)add curr_island's next_coor_island into set
